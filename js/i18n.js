...
(function() {
  ...
  const translations = {
    bg: {
      ...
      'donate.subtitle': 'Избери как искаш да помогнеш:',
      'donate.impact1': '1 дете с топли дрехи',
      'donate.impact2': '2 деца с дрехи',
      'donate.impact4': '4 деца с дрехи',
      'donate.custom': 'Друга сума',
      'donate.custom.impact': 'По ваша преценка',
      'donate.btn': 'Дари с карта',
      'donate.btn.simple': 'Дари Сега',
      'donate.bank.title': 'Предпочиташ банков превод?',
      ...
      'donate.security.secure': 'Сигурно плащане',
      'donate.security.nodata': 'Не съхраняваме данни от карти',
    ...
    en: {
      ...
      'donate.impact1': '1 child with warm clothes',
      'donate.impact2': '2 children with clothes',
      'donate.impact4': '4 children with clothes',
      'donate.custom': 'Other Amount',
      'donate.custom.impact': 'Your choice',
      'donate.btn': 'Donate by Card',
      'donate.btn.simple': 'Donate',
      'donate.bank.title': 'Prefer bank transfer?',
      'donate.bank.iban': 'IBAN:',
      'donate.bank.bank': 'Bank:',
      'donate.bank.recipient': 'Recipient:',
      'donate.bank.eik': 'Company ID:',
      'donate.bank.reason': 'Reference:',
      'donate.bank.reason.value': 'Donation Give Warmth',
      'donate.copy': 'Copy',
      'donate.copied': 'Copied!',
      'donate.security.secure': 'Secure payment',
      'donate.security.nodata': 'We don\'t store card data',
